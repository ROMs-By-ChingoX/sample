...
DEVICE_PACKAGE_OVERLAYS += device/itel/A31/overlay
PRODUCT_PACKAGE_OVERLAYS += device/itel/A31/overlay # enable this to be able overlay a default wallpaper

LOCAL_PATH := device/itel/A31
...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/enableswap.sh:system/enableswap.sh \
    $(LOCAL_KERNEL):kernel
